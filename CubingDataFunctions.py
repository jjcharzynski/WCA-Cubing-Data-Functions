...
# def downloadcuberdata(personId, *args):
#     '''
#     script to download all of a cuber's data as a .csv file
#     if just the personId is provided, data for all events will be provided.
#     if eventIds are provided, only data for those eventIds will be provided.
#     '''
#     print("This function is yet to be written.")
    
# def plotalltimeseverforanevent(eventId):
#     '''
#     script to collect all times ever for an event. (to be used in cubervseverybody)
#     '''
#     print("This function is yet to be written.")
    
# def upcomingcompetitionnearby():
#     '''
#     script to create an email alert when a new competition is available near you.
#     inputs: coordinates (lat/long or maybe zipcode), email address
#     '''
#     print("This function is yet to be written.")

#Example Usage
# createWCAdatabase()
# pullalldataforpersonandevent("2010LONG01","333")
# plotpersonalprogressbyevent("2022BROO10","333")
# plotpersonalprogressbyevent("2023CHAR14","333")
# comparecubersbyevent("333","2009ZEMD01","2012PARK03")
# comparecubersbyevent("333","2023CHAR14", "2022BROO10", "2016KOLA02","2009ZEMD01","2012PARK03", "2014WANG48")
# comparecubersbyevent("333","2023CHAR14", "2022BROO10")


# personsdf, ids = pullpersonIds()
# # print(len(ids))
# shorteridlist = ids[10000:10100]
# eventId = ("333",)
# personId = ("2023CHAR14",)
# my_tuple = eventId + personId + shorteridlist
# cubervseverybody(*my_tuple)
